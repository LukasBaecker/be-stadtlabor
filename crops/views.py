...
from .serializers import CropPutSerializer, CropSerializer
...
class CropPutViewSchema(AutoSchema):
...
class CropDetailView(APIView):
    ...
    def put(self,request,pk):
     ...
     crop_serializer = CropPutSerializer(crop, data=crop_data) 
